...
for required in 'create schema' 'create table' 'create index' 'create or replace view' 'create or replace function' 'create trigger' 'storage.receipts' 'storage.lots' 'logistics.trips'; do
