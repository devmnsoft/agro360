...
public sealed class SupportController(ISupportCustomerSuccessService service,ILogger<SupportController> logger):ControllerBase
{
 ...
 [HttpGet("articles")] public Task<IReadOnlyList<KnowledgeArticle>> Articles(string? search,string? module,bool publicOnly=true,CancellationToken ct=default)=>service.ArticlesAsync(search,module,publicOnly,ct);
