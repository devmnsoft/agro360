...
public sealed record OperationalFleetAssetCommand(string Type, string Brand, string Model, int? Year, string Identification, decimal? HourMeter, decimal? Odometer, Guid? FarmId, Guid? ResponsibleId, string Status);
...
public interface IOperationsService
{
    ...
    Task<Guid> CreateAssetAsync(OperationalFleetAssetCommand command, CancellationToken ct);
    Task UpdateAssetAsync(Guid id, OperationalFleetAssetCommand command, CancellationToken ct);
