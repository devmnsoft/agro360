...
public sealed class BillingChargeSummary { public Guid Id { get; init; } public Guid TenantId { get; init; } public string TenantName { get; init; } = string.Empty; public string PlanName { get; init; } = string.Empty; public DateOnly Competence { get; init; } public DateOnly DueOn { get; init; } public decimal BaseAmount { get; init; } public decimal AdditionalAmount { get; init; } public decimal Discount { get; init; } public decimal Amount { get; init; } public string[] ModuleCodes { get; init; } = []; public string Status { get; init; } = string.Empty; public string? Notes { get; init; } public DateOnly? PaidOn { get; init; } public decimal? PaidAmount { get; init; } }
