...
public sealed class Sprint41ExecutiveIntelligenceTests
{
    ...
    [Fact] public void Full_sql_has_governed_tenant_safe_intelligence_structures()
    {
    ...
    [Fact] public void Service_enforces_critical_decisions_sources_and_tenant()
    {
    ...
    [Fact] public void Ui_uses_business_choices_and_discloses_rule_based_recommendations()
    {
