...
public sealed class IntegrationRulesTests
{
 ...
 [Fact] public void Fiscal_document_rejects_unsupported_type()=>Assert.NotEmpty(Validate(new FiscalDocumentCommand("INVOICE","x.xml","eA==",null,null,null,null,null,null)));
